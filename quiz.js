...
const questions = [
    ...
    { id: 16, block: 'APTITUD VERBAL', text: 'Considere el siguiente texto: <p><mark>"El chiste es un dicho breve, agudo y gracioso que surge espontáneamente del pueblo; algunos investigadores y autores los recopilan para su publicación".<mark> <p>Según el texto, ¿cuál palabra sintetiza los términos subrayados?', options: ['a) Sagaz', 'b) Burlesco', 'c) Ingenioso', 'd) Perspicaz'], answer: 'c' },
